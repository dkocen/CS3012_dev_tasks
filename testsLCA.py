...
class MyTestCase(unittest.TestCase):
    ...
    def test_empty_dag(self):
        """Tests an empty DAG. Considering an empty DAG to not be a DAG"""
    ...
    def test_non_binary_tree(self):
        ...
        self.assertEqual(lca, root.right.left, f'Incorrect LCA {lca}. Should be {root.right.left}')
    ...
    def test_different_values_tree(self):
        ...
        root = build(data)
        lca1 = LCA.findLCA(root, root.left, root.right)
        lca2 = LCA.findLCA(root, root.left.left, root.left.right)
